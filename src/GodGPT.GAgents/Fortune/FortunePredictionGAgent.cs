...
{{
  ""predictions"": {{
    ""{targetLanguage}"": {{
      ""welcomeNote_zodiac"": ""{sunSign}"", ""welcomeNote_chineseZodiac"": ""{birthYearZodiac}"", ""welcomeNote_rhythm"": ""[Yin/Yang + Element]"", ""welcomeNote_essence"": ""[2 adjectives]"",
      ""fourPillars_coreIdentity"": ""[12-18 words, address by name]"", ""fourPillars_coreIdentity_expanded"": ""[45-60 words, use {sunSign} as Sun]"",
      ""chineseAstrology_currentYear"": ""Year of the {currentYearZodiac}"", ""chineseAstrology_currentYearStems"": ""{currentYearStems}"",
      ...
      ""zodiacWhisper"": ""[40-50 words, start '{birthYearAnimal} adds...']"",
      ""sunSign_name"": ""{sunSign}"", ""sunSign_tagline"": ""[You + poetic metaphor]"",
      ""westernOverview_sunSign"": ""{sunSign}"", ""westernOverview_sunArchetype"": ""[Sun in {sunSign} - The [archetype]]"", ""westernOverview_sunDescription"": ""[18-25 words]"",
      ""westernOverview_moonSign"": ""[Infer or use {sunSign}]"", ""westernOverview_moonArchetype"": ""[Moon in [sign] - The [archetype]]"", ""westernOverview_moonDescription"": ""[15-20 words]"",
      ""westernOverview_risingSign"": ""[Use {sunSign} if no time]"", ""westernOverview_risingArchetype"": ""[Rising in [sign] - The [archetype]]"", ""westernOverview_risingDescription"": ""[20-28 words]"",
      ""combinedEssence"": ""[15-20 words: think/feel/move pattern]"",
      ""strengths_overview"": ""[10-15 words]"", ""strengths_item1_title"": ""[2-5 words]"", ""strengths_item1_description"": ""[15-25 words]"", ""strengths_item2_title"": ""[2-5 words]"", ""strengths_item2_description"": ""[12-18 words]"", ""strengths_item3_title"": ""[2-5 words]"", ""strengths_item3_description"": ""[12-18 words]"",
      ""challenges_overview"": ""[12-18 words, 'Your power grows when...']"", ""challenges_item1_title"": ""[2-5 words]"", ""challenges_item1_description"": ""[8-15 words]"", ""challenges_item2_title"": ""[2-5 words]"", ""challenges_item2_description"": ""[10-18 words]"", ""challenges_item3_title"": ""[2-5 words]"", ""challenges_item3_description"": ""[10-18 words]"",
      ""destiny_overview"": ""[20-30 words, 'You are here to...']"", ""destiny_path1_title"": ""[3-5 roles with /]"", ""destiny_path1_description"": ""[3-6 words]"", ""destiny_path2_title"": ""[3-5 roles with /]"", ""destiny_path2_description"": ""[5-10 words]"", ""destiny_path3_title"": ""[1-3 roles]"", ""destiny_path3_description"": ""[8-15 words]"",
      ""chineseZodiac_animal"": ""{birthYearAnimal}"", ""chineseZodiac_essence"": ""[Essence like {birthYearElement}]"",
      ""zodiacCycle_title"": ""[Zodiac Cycle Influence (YYYY-YYYY)]"", ""zodiacCycle_cycleName"": ""[English name]"", ""zodiacCycle_cycleNameChinese"": ""[Chinese]"", ""zodiacCycle_overview"": ""[50-65 words]"", ""zodiacCycle_dayMasterPoint1"": ""[8-12 words]"", ""zodiacCycle_dayMasterPoint2"": ""[6-10 words]"", ""zodiacCycle_dayMasterPoint3"": ""[8-12 words]"", ""zodiacCycle_dayMasterPoint4"": ""[10-15 words]"",
      ""tenYearCycles_description"": ""[40-60 words]"",
      ""pastCycle_ageRange"": ""{pastCycle.AgeRange}"", ""pastCycle_period"": ""{pastCycle.Period}"", ""pastCycle_influenceSummary"": ""[8-12 words]"", ""pastCycle_meaning"": ""[60-80 words, past tense]"",
      ""currentCycle_ageRange"": ""{currentCycle.AgeRange}"", ""currentCycle_period"": ""{currentCycle.Period}"", ""currentCycle_influenceSummary"": ""[8-12 words]"", ""currentCycle_meaning"": ""[60-80 words, present tense]"",
      ""futureCycle_ageRange"": ""{futureCycle.AgeRange}"", ""futureCycle_period"": ""{futureCycle.Period}"", ""futureCycle_influenceSummary"": ""[8-12 words]"", ""futureCycle_meaning"": ""[60-80 words, future tense]"",
      ""lifePlot_title"": ""[10-20 words archetype]"", ""lifePlot_chapter"": ""[30-50 words]"", ""lifePlot_point1"": ""[5-15 words]"", ""lifePlot_point2"": ""[5-15 words]"", ""lifePlot_point3"": ""[5-15 words]"", ""lifePlot_point4"": ""[5-15 words]"",
      ""activationSteps_step1_title"": ""[2-5 words]"", ""activationSteps_step1_description"": ""[10-20 words]"", ""activationSteps_step2_title"": ""[2-5 words]"", ""activationSteps_step2_description"": ""[10-20 words]"", ""activationSteps_step3_title"": ""[2-5 words]"", ""activationSteps_step3_description"": ""[10-20 words]"", ""activationSteps_step4_title"": ""[2-5 words]"", ""activationSteps_step4_description"": ""[10-20 words]"",
      ""mantra_title"": ""[2-4 words]"", ""mantra_point1"": ""[5-15 words]"", ""mantra_point2"": ""[5-15 words]"", ""mantra_point3"": ""[5-15 words]""
    }}
  }}
}}

RULES:
- Generate VARIED creative content each time (descriptions, taglines, advice)
- Use 'You/Your' extensively, warm tone, no special chars/emoji/line breaks
- Patterns: 'both...yet', 'You are here to...', 'Your power grows when...'";
        }
        else if (type == PredictionType.Yearly)
        {
...
{{
  ""predictions"": {{
    ""{targetLanguage}"": {{
      ...
      ""westernAstroOverlay"": ""{sunSign} Sun · [archetype] — {yearlyYear} [planetary transits]"",
      ""yearlyTheme_overallTheme"": ""[4-7 words with 'of']"", ""yearlyTheme_atAGlance"": ""[15-20 words]"", ""yearlyTheme_expanded"": ""[60-80 words in 3 parts: P1 combo, P2 effect, P3 'not X but Y']"",
      ""divineInfluence_career_score"": [1-4], ""divineInfluence_career_tagline"": ""['Your superpower this year:' + 10-15 words]"", ""divineInfluence_career_bestMoves"": [""[8-12 words]"", ""[8-15 words]""], ""divineInfluence_career_avoid"": [""[3-6 activities]"", ""[3-6 activities]""], ""divineInfluence_career_inANutshell"": ""[50-70 words: P1 formula, P2 feeling, P3 meaning]"",
      ""divineInfluence_love_score"": [1-4], ""divineInfluence_love_tagline"": ""[10-15 words]"", ""divineInfluence_love_bestMoves"": [""[6-10 words]"", ""[6-12 words]""], ""divineInfluence_love_avoid"": [""[3-6 behaviors]"", ""[3-6 behaviors]""], ""divineInfluence_love_inANutshell"": ""[50-70 words: P1 formula, P2 state, P3 needs]"",
      ""divineInfluence_wealth_score"": [1-4], ""divineInfluence_wealth_tagline"": ""[10-15 words]"", ""divineInfluence_wealth_bestMoves"": [""[8-12 words]"", ""[8-15 words]""], ""divineInfluence_wealth_avoid"": [""[3-6 actions]"", ""[3-6 actions]""], ""divineInfluence_wealth_inANutshell"": ""[50-70 words: P1 formula, P2 climate, P3 needs]"",
      ""divineInfluence_health_score"": [1-4], ""divineInfluence_health_tagline"": ""[10-15 words]"", ""divineInfluence_health_bestMoves"": [""[8-12 words]"", ""[8-15 words]""], ""divineInfluence_health_avoid"": [""[3-6 habits]"", ""[3-6 habits]""], ""divineInfluence_health_inANutshell"": ""[50-70 words: P1 formula, P2 state, P3 needs]"",
      ""embodimentMantra"": ""[18-25 words, use 'My' declarations]""
    }}
  }}
}}

RULES:
- Scores 1-4 vary by analysis (1=challenging, 4=excellent)
- Generate VARIED content: themes, scores, advice, mantras
- Use 'You/Your' (mantra uses 'My'), warm tone, no special chars/emoji/line breaks";
        }
        else // PredictionType.Daily
        {
...
{{
  ""predictions"": {{
    ""{targetLanguage}"": {{
      ...
      ""todaysReading_tarotCard_name"": ""[Select DIFFERENT card for {sunSign}/{zodiacElement} + today's energy from full 78-card deck]"", ""todaysReading_tarotCard_represents"": ""[1-2 words]"", ""todaysReading_tarotCard_orientation"": ""[Upright/Reversed based on {sunSign} phase]"",
      ""todaysReading_pathTitle"": ""{{firstName}}'s Path Today - A [Adjective] Path"",
      ""todaysReading_pathDescription"": ""[15-25 words, Hi {{firstName}}...]"", ""todaysReading_pathDescriptionExpanded"": ""[30-40 words]"",
      ""todaysReading_careerAndWork"": ""[10-20 words]"", ""todaysReading_loveAndRelationships"": ""[10-20 words]"", ""todaysReading_wealthAndFinance"": ""[10-20 words]"", ""todaysReading_healthAndWellness"": ""[10-15 words]"",
      ""todaysTakeaway"": ""[15-25 words, '{{firstName}}, your...']"",
      ""luckyAlignments_luckyNumber_number"": ""[Generate varied number 1-9, e.g., Seven (7)]"", ""luckyAlignments_luckyNumber_digit"": ""[1-9]"", ""luckyAlignments_luckyNumber_description"": ""[15-20 words]"", ""luckyAlignments_luckyNumber_calculation"": ""[12-18 words formula example]"",
      ""luckyAlignments_luckyStone"": ""[Select stone for {zodiacElement}: Fire→Carnelian/Ruby, Earth→Jade/Emerald, Air→Citrine/Aquamarine, Water→Moonstone/Pearl]"", ""luckyAlignments_luckyStone_description"": ""[15-20 words]"", ""luckyAlignments_luckyStone_guidance"": ""[15-20 words, 'Meditate:' or 'Practice:']"",
      ""luckyAlignments_luckySpell"": ""[2 words]"", ""luckyAlignments_luckySpell_description"": ""[20-30 words, quote format]"", ""luckyAlignments_luckySpell_intent"": ""[10-12 words, 'To...']"",
      ""twistOfFate_favorable"": [""[3-6 activities]"", ""[3-6 activities]""], ""twistOfFate_avoid"": [""[3-6 activities]"", ""[3-6 activities]""], ""twistOfFate_todaysRecommendation"": ""[10-15 words, 'Today's turning point...']""
    }}
  }}
}}

RULES:
- PERSONALIZE: Tarot card by {sunSign}/{zodiacElement}, stone by {zodiacElement}
- VARY: All content must be unique per user - different cards, stones, advice
- Use 'You/Your' extensively, warm tone, no special chars/emoji/line breaks";            
        }
